            ...
            <div>
                <div className="mx-auto text-center py-16  sm:py-20 sm:px-6 ">
                    <h2 className="text-6xl font-extrabold text-white">
                        <span className="block mb-4">$349/month <span className='text-red-600'>SEO Growth Package</span></span>
                    </h2>
                    <p className="mt-4 text-lg leading-6 text-zinc-200">Your website SEO is one of the most crucial and important aspects of your website. I want you listed first on Search Engines, let me help you get you there!</p>
